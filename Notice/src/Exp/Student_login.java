...
public class Student_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(426, 353));

        jPanel2.setBackground(new java.awt.Color(51, 204, 255));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/reg.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         if(jTextField1.getText().length()==0||jPasswordField1.getText().length()==0){
             JOptionPane.showMessageDialog(jButton1,"Please fill All the fields");
         }else{
             try{
                 Connection con;
                 ResultSet rs;
                 ...
                 String sql="select * from signup where userid=? and password=?";
